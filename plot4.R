...
with(data,plot(data$Datetime, as.numeric(as.character(Voltage)), type="l", ylab="Voltage",
               xlab="datetime"))
...
with(data,plot(data$Datetime, as.numeric(as.character(Global_reactive_power)), type="l", ylab="Global_reactive_power",
               xlab="datetime"))
